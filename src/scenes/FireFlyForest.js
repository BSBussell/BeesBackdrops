...
await PIXI.Assets.load([
	{ alias: 'sky', src: './assets/TreeLayers/bg_sky_4.png' },
	{ alias: 'stars', src: './assets/TreeLayers/background_sky_green.png' },
	{ alias: 'moon', src: './assets/TreeLayers/moon.png' },
	{ alias: 'mountains', src: './assets/TreeLayers/bg_mountains_3.png' },
	{ alias: 'trees', src: './assets/TreeLayers/bg_treeline_2.png' },
	{ alias: 'godray', src: './assets/TreeLayers/bg_godlight.png' },
	{ alias: 'foreground', src: './assets/TreeLayers/bg_treeline_1.png' },
...
// Stars Layer
const starsTexture = PIXI.Assets.get('stars');
...
// Tree Layer
const treesTexture = PIXI.Assets.get('trees');
...
// GodRay Layer
const godrayTexture = PIXI.Assets.get('godray');
...
// Fireflies particle
const firefliesTexture = PIXI.Assets.get('fireflies');
const lightTexture = PIXI.Assets.get('pixel_light');
...
// Foreground Layer
const foregroundTexture = PIXI.Assets.get('foreground');
